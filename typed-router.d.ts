...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/cultures/': RouteRecordInfo<'/cultures/', '/cultures', Record<never, never>, Record<never, never>>,
    '/cultures/[id]': RouteRecordInfo<'/cultures/[id]', '/cultures/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
